...
// ============================================
// EVOLUTION DASHBOARD & TEAM CHAT
// Real-time visualization of AI agents learning
// ============================================
const evolutionRoutes = require('./evolution_routes');
app.use('/api/evolution', evolutionRoutes);
console.log('[EVOLUTION] Dashboard routes mounted at /api/evolution');
console.log('[EVOLUTION] Features: Agent Status, Training Logs, Team Chat');
