...
import { useSocket } from './contexts/SocketContext'; // Import Hook
...
function PaymentDashboard() {
  ...
  useEffect(() => {
    ...
    if (socket) {
      socket.on('payment:transaction', handleTransaction);
    }

    return () => {
      isMounted = false;
      clearInterval(interval);
      if (socket) socket.off('payment:transaction', handleTransaction);
    };
